...
"כמה מטבעות של 5 או 2 נכנסים ב-X" — הכפל הראשון. כל מפגש מערבב את שני סוגי המטבע: ₪5 (יעדים 10/15/20) ו-₪2 (יעדים 4/6/8). בעיה `{t:TCM,a,b}` כאשר a הוא היעד ו-b ערך המטבע (2 או 5); **התשובה היא a/b** (מספר המטבעות).
