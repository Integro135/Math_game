...
window.EXERCISES.types.word_match=(()=>{
  ...
  .wm-title{direction:rtl;font-family:'Fredoka One','Heebo',sans-serif;font-size:1.25rem;
  ...
  .wm-word{font-family:'Fredoka One','Heebo',sans-serif;font-size:1.3rem;color:var(--skin-text,#fff);
  ...
  .wm-placed{font-family:'Fredoka One','Heebo',sans-serif;font-size:1.15rem;color:#a5ffc2;
  ...
  .wm-ghost{position:fixed;z-index:9999;pointer-events:none;opacity:.92;transform:translate(-50%,-50%);
    font-family:'Fredoka One','Heebo',sans-serif;font-size:1.3rem;color:#fff;
    background:rgba(157,78,221,.9);border:2px solid #fff;border-radius:999px;padding:8px 20px;
    box-shadow:0 10px 26px rgba(0,0,0,.4)}
  @media(max-width:480px){.wm-pic{width:96px;min-height:104px}.wm-pic .wm-emoji{font-size:2.4rem}.wm-word{font-size:1.1rem;padding:7px 15px}}`;
