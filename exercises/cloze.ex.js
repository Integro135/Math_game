...
window.EXERCISES.types.cloze=(()=>{
  ...
  const BANK=[
    ...
    {pre:'בַּלַּיְלָה רָאִיתִי',post:'מָתוֹק.',opts:['חֲלוֹם','שִׁעוּר','מַסְמֵר']},
    ...
    {pre:'אִמָּא קָרְאָה לִי',post:'לִפְנֵי הַשֵּׁנָה.',opts:['סִפּוּר','מַגְהֵץ','אֶבֶן']},
    ...
    {pre:'בַּבֹּקֶר צִחְצַחְנוּ אֶת',post:'בְּמִבְרֶשֶׁת.',opts:['הַשִּׁנַּיִם','הַמָּרָק','הַיָּרֵחַ']},
    {pre:'כְּשֶׁהָיָה קַר בַּחוּץ לָבַשְׁנוּ',post:'חַם.',opts:['מְעִיל','שֶׁלֶג','עִפָּרוֹן']},
    {pre:'הַפָּרָה אָכְלָה',post:'בַּשָּׂדֶה.',opts:['עֵשֶׂב','כַּפִּית','דֶּגֶל']},
    {pre:'הַמּוֹרָה נָתְנָה לָנוּ',post:'חֲדָשׁוֹת.',opts:['מַחְבָּרוֹת','דְּלָתוֹת','מַדְרֵגוֹת']},
    {pre:'אַבָּא טִגֵּן',post:'בַּמַּחֲבַת.',opts:['בֵּיצָה','מַפִּית','גֶּרֶב']},
    {pre:'הַכֶּלֶב קָבַר אֶת',post:'בֶּחָצֵר.',opts:['הָעֶצֶם','הַשֶּׁמֶשׁ','הַגֶּשֶׁם']},
    {pre:'סַבָּא קָרָא',post:'עַל הַסַּפָּה.',opts:['עִתּוֹן','כָּרִית','שְׂמִיכָה']},
    {pre:'עָלִינוּ עַל',post:'וְנָסַעְנוּ לַגַּן.',opts:['הָאוֹטוֹבּוּס','הַגַּג','הַמִּטָּה']},
    {pre:'עַל הָעֵץ גָּדֵל',post:'אָדֹם וּמָתוֹק.',opts:['תַּפּוּחַ','שָׁעוֹן','סַנְדָּל']},
    {pre:'עַל הָעוּגָה הִדְלַקְנוּ',post:'קְטַנִּים.',opts:['נֵרוֹת','בַּלּוֹנִים','מַגָּפַיִם']},
    {pre:'לְיַד הַיָּם בָּנִינוּ אַרְמוֹן מִן',post:'.',opts:['הַחוֹל','הָרוּחַ','הֶחָלָב']},
    {pre:'בַּמַּכֹּלֶת קָנִינוּ',post:'טָרִי.',opts:['לֶחֶם','שָׁטִיחַ','טֶלֶפוֹן']},
  ];
  ...
  .cz-sent{direction:rtl;text-align:center;line-height:1.9;width:100%;
    ...
    font-size:2.05rem;color:var(--skin-text,#fff);
  ...
  .cz-opt{font-family:'Fredoka One','Heebo',sans-serif;font-size:1.85rem;color:var(--skin-text,#fff);
  ...
  @media(max-width:480px){.cz-sent{font-size:1.75rem}.cz-opt{font-size:1.55rem;padding:8px 11px}}`;
