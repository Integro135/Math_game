...
window.EXERCISES.types.sent_order=(()=>{
  ...
  .so-title{direction:rtl;font-family:'Fredoka One','Heebo',sans-serif;font-size:1.7rem;
  ...
  .so-strip .so-hintword{font-family:'Fredoka One','Heebo',sans-serif;font-size:1.5rem;
  ...
  .so-word{font-family:'Fredoka One','Heebo',sans-serif;font-size:1.85rem;color:var(--skin-text,#fff);
  ...
  @media(max-width:480px){.so-word{font-size:1.55rem;padding:7px 14px}}`;
