...
window.EXERCISES.types.story_quiz=(()=>{
  ...
  const LIB={
    space:[
      ...
      {lines:['דָּנָה חָלְמָה לָטוּס לֶחָלָל.','הִיא בָּנְתָה חֲלָלִית מִקַּרְטוֹן.','הִיא לָבְשָׁה חֲלִיפַת חָלָל לְבָנָה.','בַּחֲלוֹם הִיא רִחֲפָה בֵּין הַכּוֹכָבִים.'],
      ...
      {lines:['רוֹן קִבֵּל טֶלֶסְקוֹפּ לְיוֹם הַהֻלֶּדֶת.','בַּלַּיְלָה הוּא הִסְתַּכֵּל בַּיָּרֵחַ דֶּרֶךְ הַטֶּלֶסְקוֹפּ.','הוּא רָאָה הָרִים וּמַכְתְּשִׁים עֲגֻלִּים.','רוֹן צִיֵּר אֶת מָה שֶׁרָאָה בְּמַחְבֶּרֶת.'],
       q:'מָה קִבֵּל רוֹן לְיוֹם הַהֻלֶּדֶת?',
       opts:['טֶלֶסְקוֹפּ','אוֹפַנַּיִם','כַּדּוּרְסַל'],c:0},
      {lines:['הָאַסְטְרוֹנָאוּטִית הָרִאשׁוֹנָה בָּעוֹלָם טָסָה לֶחָלָל.','קָרְאוּ לָהּ וָלֶנְטִינָה.','הִיא הִקִּיפָה אֶת כַּדּוּר הָאָרֶץ אַרְבָּעִים וָשֵׁשׁ פְּעָמִים.','כְּשֶׁחָזְרָה — כֻּלָּם מָחֲאוּ לָהּ כַּפַּיִם.'],
    ...
    dinos:[
      ...
      {lines:['הַוֶּלוֹצִירַפְּטוֹר הָיָה דִּינוֹזָאוּר קָטָן וּמָהִיר.','הוּא צָד בְּלַהֲקָה עִם הַחֲבֵרִים שֶׁלּוֹ.','לְפִי הַמַּדְעָנִים — הָיוּ לוֹ נוֹצוֹת!','הוּא קָרוֹב מִשְׁפָּחָה שֶׁל הַצִּפּוֹרִים.'],
