...
window.EXERCISES.types.true_false=(()=>{
  ...
  const BANK=[
    ...
    {lines:['בַּחֹרֶף קַר בַּחוּץ.','לוֹבְשִׁים מְעִיל וְחוֹבְשִׁים כּוֹבַע.'],stmt:'בַּחֹרֶף לוֹבְשִׁים בֶּגֶד יָם.',truth:false},
    ...
    {lines:['לְאֵיתָן יֵשׁ שְׁתֵּי מְכוֹנִיּוֹת צַעֲצוּעַ.','הַגְּדוֹלָה אֲדֻמָּה וְהַקְּטַנָּה צְהֻבָּה.'],stmt:'הַמְּכוֹנִית הַגְּדוֹלָה שֶׁל אֵיתָן צְהֻבָּה.',truth:false},
    {lines:['מִיכַל הֵכִינָה כּוֹס תֵּה לְסַבָּא.','סַבָּא שָׁתָה וְאָמַר תּוֹדָה רַבָּה.'],stmt:'סַבָּא שָׁתָה אֶת הַתֵּה שֶׁמִּיכַל הֵכִינָה.',truth:true},
    {lines:['מַתָּן הֵבִיא לַגַּן אֲבַטִּיחַ גָּדוֹל.','הַגַּנֶּנֶת חִלְּקָה אוֹתוֹ לְכֻלָּם.'],stmt:'הַגַּנֶּנֶת הֵבִיאָה לַגַּן אֲבַטִּיחַ גָּדוֹל.',truth:false},
    {lines:['הִלָּה רָקְדָה בַּהַצָּגָה שֶׁל הַגַּן.','אַבָּא וְאִמָּא יָשְׁבוּ בַּשּׁוּרָה הָרִאשׁוֹנָה.'],stmt:'הַהוֹרִים שֶׁל הִלָּה יָשְׁבוּ בַּשּׁוּרָה הָרִאשׁוֹנָה.',truth:true},
    {lines:['בַּבֹּקֶר יָאִיר הֶאֱכִיל אֶת הַדָּגִים.','אָחִיו הִשְׁקָה אֶת הַפְּרָחִים בַּמִּרְפֶּסֶת.'],stmt:'יָאִיר הִשְׁקָה אֶת הַפְּרָחִים בַּמִּרְפֶּסֶת.',truth:false},
    {lines:['אַיֶּלֶת שָׁכְחָה אֶת הַמִּטְרִיָּה בַּבַּיִת.','בַּדֶּרֶךְ לַגַּן הִתְחִיל לָרֶדֶת גֶּשֶׁם.'],stmt:'הַמִּטְרִיָּה שֶׁל אַיֶּלֶת נִשְׁאֲרָה בַּבַּיִת.',truth:true},
    {lines:['דָּוִד שָׂם אֶת הַנַּעֲלַיִם מִתַּחַת לַמִּטָּה.','הוּא תָּלָה אֶת הַמְּעִיל עַל הַדֶּלֶת.'],stmt:'דָּוִד שָׂם אֶת הַמְּעִיל מִתַּחַת לַמִּטָּה.',truth:false},
    {lines:['שָׂרָה קִבְּלָה בַּלּוֹן כָּחֹל וְגַם בַּלּוֹן אָדֹם.','אֶת הָאָדֹם הִיא נָתְנָה לְאָחִיהָ הַקָּטָן.'],stmt:'לְשָׂרָה נִשְׁאַר הַבַּלּוֹן הַכָּחֹל.',truth:true},
    {lines:['רוֹעִי הָלַךְ עִם סַבְתָּא לַשּׁוּק.','הֵם קָנוּ שָׁם לֶחֶם וּבֵיצִים.'],stmt:'סַבְתָּא וְרוֹעִי קָנוּ לֶחֶם בַּשּׁוּק.',truth:true},
    {lines:['קֶרֶן פָּתְחָה אֶת הַחַלּוֹן בַּחֶדֶר.','צִפּוֹר קְטַנָּה יָשְׁבָה עַל הָעֵץ בַּחוּץ.'],stmt:'הַצִּפּוֹר יָשְׁבָה עַל הַחַלּוֹן.',truth:false},
    {lines:['גִּיל בִּקֵּשׁ מֵאִמָּא גְּלִידַת שׁוֹקוֹלָד.','אִמָּא קָנְתָה לוֹ גְּלִידַת תּוּת.'],stmt:'גִּיל קִבֵּל גְּלִידַת שׁוֹקוֹלָד.',truth:false},
    {lines:['יוֹאָב הִשְׁאִיל עִפָּרוֹן אָדֹם לְחָבֵר שֶׁלּוֹ.','אַחֲרֵי הַשִּׁעוּר הֶחָבֵר הֶחֱזִיר אוֹתוֹ.'],stmt:'הָעִפָּרוֹן חָזַר לְיוֹאָב אַחֲרֵי הַשִּׁעוּר.',truth:true},
  ];
